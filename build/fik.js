(function (global, factory) {
	...
	var _Math = {
	  ...
	  manhattanDistanceBetween: function(v1, v2) {
	    return (
	      Math.abs(v2.x - v1.x) + Math.abs(v2.x - v1.x) + Math.abs(v2.x - v1.x)
	    );
	  },
	      ...
	      if (i !== 0) {
	        ...
	        if (this.fixedBaseMode) {
	          ...
	          bone.setStartLocation(
	            bone.end.minus(bone.getDirectionUV().multiplyScalar(boneLength))
	          );
	        }
